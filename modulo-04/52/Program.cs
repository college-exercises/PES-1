...
namespace _52
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int qi = 20, n = qi, n2 = 0, a; //indice de loop geral, indice de loop secundário, quantidade de indices do vetor, auxiliar de transferencia
            ...
            while (n > 0)   //loop para percorrer o arrayNumeros
            {
