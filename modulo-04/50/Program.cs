...
namespace _50
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int n = 0, q = 0, n1 = 1;  //indice de looping, quantidade de pessoas listadas, indice para loop de exibição 10-10
            ...
            while (n < 100) //looping para exibição dos nomes e idades
            {
                ...
                Console.WriteLine();
                Console.WriteLine("Pressione qualquer teclapara exibir mais 10 \"dados\".");
                Console.ReadKey();
                n1 = 1;
            }
